...
const stages = [
  {
    ...
    icon: Megaphone,
    description:
      "Reach the right audience through Google, Meta, and targeted campaigns.",
  },
  {
    number: "02",
    title: "Leads",
    icon: UserRoundCheck,
    description:
      "Turn attention into enquiries through landing pages, forms, and campaigns.",
  },
  {
    number: "03",
    title: "Qualification",
    icon: Cpu,
    description:
      "Identify high-intent prospects using qualification, AI, and automation.",
  },
  {
    number: "04",
    title: "Conversion",
    icon: CircleCheck,
    description:
      "Turn qualified prospects into customers through better sales journeys.",
  },
  {
    number: "05",
    title: "Automation",
    icon: Zap,
    description:
      "Automate repetitive marketing and customer processes with AI.",
  },
  {
    number: "06",
    title: "Revenue",
    icon: TrendingUp,
    description:
      "Measure ROI and continuously optimize for scalable business growth.",
  },
];
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-sm md:text-base text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            We connect marketing, technology, and AI into one system that turns
